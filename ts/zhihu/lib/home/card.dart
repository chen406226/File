...
class _CardPageState extends State<CardPage> {
  ...
  prin(n){
    print("sdfffffffffffffffffffffffffffffffffffffffffffffffff");
    print(n);
  }
          ...
          Row(
            children: <Widget>[
              Padding(padding: EdgeInsets.fromLTRB(0, 10, 0, 0),
                child: Text("请与11月23号之前还款，以免产生额外费用",style: TextStyle(fontSize: 16,color: Color(0xffe6e13f)),),
              ),
            ],
          )
        ],
                ...
                child: new Row(
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Align(
                        child: Icon(
                          true?Icons.notifications_active:Icons.notifications_none,
...
//              new Text("sdf撒的发",style: TextStyle(color: Colors.black,fontSize: 20)),
              new Container(
                        ...
                        child: Container(
                          child: new ConstrainedBox(
                              child: new Swiper(
                                ...
                                itemBuilder: (c, n) {
                                  return Text(noticelist[n],maxLines: 1,overflow: TextOverflow.fade,style: TextStyle(color: Colors.black),textAlign:TextAlign.left,);
                                },
                ...
                children: <Widget>[
                   Container(
                     child:ButtonTheme(
                       ...
                       child: FlatButton.icon(
                         icon: Icon(Icons.call,size: 20.0,color: Colors.blueGrey,),
                         label: Text("客服中心",style: TextStyle(color: Colors.grey),),
                         onPressed: (){prin(23);},
                       ),
                     ),
                     decoration: new BoxDecoration(
                  ...
                  Container(
                    child:ButtonTheme(
                      ...
                      child: FlatButton.icon(
                        icon: Icon(Icons.help,size: 20.0,color: Colors.blueGrey,),
                        label: Text("帮助中心",style: TextStyle(color: Colors.grey),),
                        onPressed: (){prin(23);},
                      ),
                    ),
                    decoration: new BoxDecoration(
...
//                    new Text('还款计算机',style: TextStyle(color:Colors.red),),
//                  ],
//                ),
//              ),
            ],
