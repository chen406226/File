...
import 'package:flutter_range_slider/flutter_range_slider.dart' as prefix;
...
class RangeSliderData {
  ...
  // based on parameters
  //
  Widget build(BuildContext context, prefix.RangeSliderCallback callback) {
