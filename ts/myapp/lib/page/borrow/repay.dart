                    ...
                    Row(
                      children: <Widget>[
                        Padding(
                          ...
                          child:Text("本次账单包含本金3000元，滞纳金22元",style: TextStyle(fontSize: 14,color: Color(0xffdddddd)),),
                        ),
                      ],
                    )
                  ],
...
//                    buttonColor:Colors.green,
              ...
              child: FlatButton(
                child: Text("确认还款",style: TextStyle(color: Colors.white),),
...
//              buttonColor:Color(0xffedf3ff),
              ...
              child: FlatButton(
                child:Container(
                  child: Column(
                    children: <Widget>[
                      Text("展期还款",style: TextStyle(fontWeight: FontWeight.bold),),
                      Text("延长还款时间，还款轻松无压力",style: TextStyle(fontSize: 11,color: Color(0xffaaaaaa)),),
